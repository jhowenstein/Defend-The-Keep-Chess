...
wRook_img = pygame.image.load('Chess_rlt60.png')
wKnight_img = pygame.image.load('Chess_nlt60.png')
wPawn_img = pygame.image.load('Chess_plt60.png')

bKing_img = pygame.image.load('Chess_kdt60.png')
bQueen_img = pygame.image.load('Chess_qdt60.png')
bBishop_img = pygame.image.load('Chess_bdt60.png')
...
while WHITE_KEEP.status and BLACK_KEEP.status:
	...
	while SELECT == True:
		...
		if row < 0 or row > 10:
			...
			highlightSpace(DISPLAYSURF, XMARGIN, YMARGIN, HIGHLIGHT_COLOR, row, col)
			SELECT = 0
